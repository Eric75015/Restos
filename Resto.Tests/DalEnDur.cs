...
namespace Resto.Tests
{
    ...
    {
        private List<Resto.Models.Resto> listeDesRestaurants;
        private List<Utilisateur> listeDesUtilisateurs;
        private List<Sondage> listeDessondages;

        public DalEnDur()
        {
            listeDesRestaurants = new List<Resto.Models.Resto>
        {
            new Resto.Models.Resto { Id = 1, Nom = "Resto pinambour", Telephone = "0102030405"},
            new Resto.Models.Resto { Id = 2, Nom = "Resto pinière", Telephone = "0102030405"},
            new Resto.Models.Resto { Id = 3, Nom = "Resto toro", Telephone = "0102030405"},
        };
            listeDesUtilisateurs = new List<Utilisateur>();
            listeDessondages = new List<Sondage>();
        }

        public List<Resto.Models.Resto> ObtientTousLesRestaurants()
        {
        ...
        public void CreerRestaurant(string nom, string telephone)
        {
            ...
            listeDesRestaurants.Add(new Resto.Models.Resto { Id = id, Nom = nom, Telephone = telephone });
        }
