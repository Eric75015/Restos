...
namespace Resto.Controllers
{
    public class RestaurantController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Resto.Models.Resto> listeDesRestaurants = dal.ObtientTousLesRestaurants();
        ...
        public ActionResult ModifierRestaurant(int? id)
        {
            if (id.HasValue)
            {
                ...
                Models.Resto restaurant = dal.ObtientTousLesRestaurants().FirstOrDefault(r => r.Id == id.Value);
                if (restaurant == null)
                    return View("Error");
        ...
        [HttpPost]
        public ActionResult ModifierRestaurant(Models.Resto resto)
        {
        ...
        [HttpPost]
        public ActionResult CreerRestaurant(Models.Resto resto)
        {
